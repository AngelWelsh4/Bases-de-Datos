...
drop database if exists `replicas`;
create database if not exists `replicas`;
...
(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saúde n. 58',NULL,'NYC',NULL,'1756','Portugal',NULL,'0.00'),
...
(293,'BG&E Collectables','Harrison','Ed','+41 26 425 50 01','Rte des Arsenaux 41 ',NULL,'Sydney',NULL,'1700','Switzerland',NULL,'0.00'),
...
(324,'Stylish Desk Decors, Co.','Brown','Ann ','(171) 555-0297','35 King George',NULL,'Boston',NULL,'WX3 6FW','UK',1501,'77000.00'),
...
(348,'Asian Treasures, Inc.','McKenna','Patricia ','2967 555','8 Johnstown Road',NULL,'NYC','Co. NYC',NULL,'Ireland',NULL,'0.00'),
...
(356,'SAR Distributors, Co','Kuger','Armand','+27 21 550 3555','1250 Pretorius Street',NULL,'Tokyo','Pretoria','0028','South Africa',NULL,'0.00'),
...
(369,'NYC Souveniers, Inc','Rodriguez','Lino ','(1) 354-2555','Jardim das rosas n. 32',NULL,'NYC',NULL,'1675','Portugal',NULL,'0.00'),
(376,'Precious Collectables','Urs','Braun','0452-076555','Hauptstr. 29',NULL,'NYC',NULL,'3012','Switzerland',1702,'0.00'),
...
(409,'Paris Collectable Exchange','Müller','Rita ','0711-555361','Adenauerallee 900',NULL,'Paris',NULL,'70563','Germany',NULL,'0.00'),
...
(481,'Raanan Stores, Inc','Altagar,G M','Raanan','+ 972 9 959 8555','3 Hagalim Blv.',NULL,'NYC',NULL,'47625','Israel',NULL,'0.00'),
...
(489,'Double Decker Gift Stores, Ltd','Smith','Thomas ','(171) 555-7555','120 Hanover Sq.',NULL,'Boston',NULL,'WA1 1DP','UK',1501,'43300.00'),
...
('8','Mexico City','+52 22 8156 6060','Investigación Científica, C.U.','s.n.','CDMX','Mexico','04510','ND');
...
('Kids Vehicles', 'Ranging from bicycles to scooters, our high-detail and color-accurate replicas will have even the toughest heart softened by nostalgia.',NULL,NULL),

('Subways',"Each replica is meticulously painted by hand resulting in a piece worth of representing every city's version of this iconic transportation.",NULL,NULL);
...
select count(*) as num_registros from orderdetails;
